export default function Designbtn() {
  return (
    <button className="contact-btn flex text-black uppercase py-3 pl-10 pr-12 text-[11px] font-bold bg-white relative transition-all overflow-hidden z-10 tracking-wider group hover:text-white  hover:bg-white">
      <span className="mr-6">Design a Quote</span>
      <svg
